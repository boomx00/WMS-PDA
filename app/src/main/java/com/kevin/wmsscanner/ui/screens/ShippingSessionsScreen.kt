...
fun ShippingSessionsScreen(navController: NavHostController) {
    ...
    suspend fun refreshSessions() {
        ...
        try {
            ...
            // leave sessions as-is on failure
        }
    ...
    Column(
        ...
        Text("Shipping", style = MaterialTheme.typography.headlineMedium)
        Spacer(modifier = Modifier.height(24.dp))

        Text("Daftar diri ke SO", style = MaterialTheme.typography.titleSmall)
        ...
        Text("Riwayat SO", style = MaterialTheme.typography.titleSmall)
        Spacer(modifier = Modifier.height(8.dp))
